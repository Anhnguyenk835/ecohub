...
class Thresholds(BaseModel):
    ...
    ph: Optional[ThresholdSetting] = Field(None, alias="pH", description="pH threshold")
    co2: Optional[ThresholdSetting] = Field(None, alias="Co2", description="Co2 threshold (ppm)")
